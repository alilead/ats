...
const Services = () => {
  ...
  const currentAudience = t.services.servicesData[audience];
  ...
  <section id="services" className="py-12 md:py-20 bg-gradient-to-b from-muted/30 to-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {currentAudience && Object.entries(currentAudience.categories).map(([key, category]) => (
            <Card key={key} className="group hover:shadow-xl transition-all duration-300 overflow-hidden border-border/50 hover:border-accent/50">
              <div className="p-4">
